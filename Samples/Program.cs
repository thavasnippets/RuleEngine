        ...
        private static RuleViewModal prepareRules() =>
            ...
            new RuleViewModal
            {
                ...
                Rules = new List<Rule>{
                    ...
                    new Rule{Id=2,RulesetId=1,Parameter="loyalityFactor",RelationalOperator="<",Value="5",LogicalOperator="AND"},
                    new Rule{Id=3,RulesetId=1,Parameter="totalPurchases",RelationalOperator=">",Value="1500",LogicalOperator=""},
